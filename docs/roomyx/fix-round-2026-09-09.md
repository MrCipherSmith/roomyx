...
[
 ...
 },
 {
  ...
  "disposition": {
   "state": "acted-on",
   "evidence": "commit fa51621d63d63771116db24faad654b9bf8113c6 — the CLI re-entry guard and the cleanup ordering are now pinned by test/server/shutdown-order.test.ts, after a verifier showed the subprocess test did not pin either; transport.onclose and the clip width guard are labelled unreachable rather than claimed pinned"
  },
 ...
 },
 {
  ...
  "disposition": {
   "state": "acted-on",
   "evidence": "commit fa51621d63d63771116db24faad654b9bf8113c6 — NOT closed: the test written for it does not reproduce the defect, and test/client/reconnect-rate.test.ts says so in its header. Recorded as the one gap this round leaves open."
  },
 ...
 },
 {
  ...
  "disposition": {
   "state": "acted-on",
   "evidence": "commit fa51621d63d63771116db24faad654b9bf8113c6 — every condition-standing-in sleep in the two named files is a predicate wait through test/helpers/until.ts; the four setTimeout sites left are two hang detectors and two assertions about absence, where a duration is the right instrument"
  },
 ...
 },
 {
  ...
  "disposition": {
   "state": "acted-on",
   "evidence": "commit fa51621d63d63771116db24faad654b9bf8113c6 — the table is published and its counts restated against itself (21 red, 7 green, 28 mutations); the stage counts restated against the dispositions the block actually carries"
  },
