...
created_at: 2026-09-10T04:21:09.244Z
context_mode: light
...
claims_applied: 19
claims_rejected: 0
verdicts_capped_to_unverifiable: 2
confirmed: 15
refuted: 2
unverifiable: 2
unverified: 0
...
| finding | claimed | recorded | why |
|---|---|---|---|
| flow-001-fixround#fix-13 | confirmed | unverifiable | reasoning alone produces no new evidence, so it records `unverifiable`. Run something, or check the class_scope sites. |
| flow-001-fixround#fix-16 | confirmed | unverifiable | reasoning alone produces no new evidence, so it records `unverifiable`. Run something, or check the class_scope sites. |
