...
- fix-11: acted-on — commit c1297e3502555ef828ec7d69ceb8d321d79f0213 — NOT closed: the test written for it does not reproduce the defect, and test/client/reconnect-rate.test.ts says so in its header. Recorded as the one gap this round leaves open. (valid_followup, post_flow_feedback).
